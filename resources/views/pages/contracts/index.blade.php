                ...
                <div class="table-wrapper table-responsive">
                    <table class="table striped-table">
                        ...
                        <tr>
                            ...
                            <th scope="col">Governing laws</th>
                        ...
                        @foreach( $contracts as $contract)
                            <tr>
                                ...
                                <td> <p>{{ $contract->governing_law }}</p></td>
{{--                                <td> <p>{{ $proforma->client->name }}</p></td>--}}
                                <td>
                                    <a href="{{ route('contracts.edit', $contract->id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit client">
