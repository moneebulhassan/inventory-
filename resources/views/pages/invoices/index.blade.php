                    ...
                    <table class="table striped-table">
                        ...
                        @foreach( $invoices as $invoice)
                            <tr>
                                ...
                                <td> <p>{{ $invoice->bl_num }}</p></td>
                                <td> <p>{{ $invoice->vessel }}</p></td>
                                <td> <p>{{ $invoice->final_destination }}</p></td>
                                <td>
                                    <a href="{{ route('invoices.edit',$invoice->id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit client">
