                ...
                <div class="form-group">
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('due_date') class="form-control is-invalid" @enderror type="date" name="due_date" id="due_date" placeholder="{{ __('Due Date') }}" required autocomplete="due_date" autofocus>
                            @error('due_date')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('country_of_origin') class="form-control is-invalid" @enderror type="text" name="country_of_origin" id="country_of_origin" placeholder="{{ __('country of origin') }}" required autocomplete="country_of_origin" autofocus>
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('shipment_period') class="form-control is-invalid" @enderror type="text" name="shipment_period" id="shipment_period" placeholder="{{ __('Shipment Period') }}" required autocomplete="shipment_period" autofocus>
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('insurance') class="form-control is-invalid" @enderror type="text" name="insurance" id="insurance" placeholder="{{ __('Insurance') }}" required autocomplete="insurance" autofocus>
                            @error('insurance')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('inspection') class="form-control is-invalid" @enderror type="text" name="inspection" id="inspection" placeholder="{{ __('inspection') }}" required autocomplete="inspection" autofocus>
                            @error('inspection')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input @error('currency') class="form-control is-invalid" @enderror type="text" name="currency" id="currency" placeholder="{{ __('currency') }}" required autocomplete="currency" autofocus>
                            @error('currency')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
